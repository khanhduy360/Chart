...
public class pieChart7 extends AppCompatActivity {
...
//
    ...
    private void setData7(int count, float range) {
        ...
        data7.setValueFormatter(new PercentFormatter());//thêm sô phân trăm
        data7.setValueTextSize(13f); //kích thước số liệu
