...
public class BarChart7 extends AppCompatActivity {
    BarChart mChart;
    TextView textView, textView2, textView3, textView4, textView5, textView6, textView7, textView8;
    String Des1, Des2, Des3, Des4, Des5, Des6, Des7, Title;
    BarData databar7;
    double amountbar1, amountbar2, amountbar3, amountbar4, amountbar5, amountbar6, amountbar7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        l.setXEntrySpace(4f);
        setData7(7, 100);
        mChart.setData(databar7); //Đã khai báo ở trên BarData databar3;
    ...
    private void setData7(int count, float range) {
        ...
        Double[] Y7={amountbar1,amountbar2,amountbar3,amountbar4,amountbar5,amountbar6,amountbar7};
        ArrayList<BarEntry> yVals7 = new ArrayList<>();
        for (int i = 0; i < count ; i++) {
            double val7 =  (Y7[i]);
            yVals7.add(new BarEntry(i+1, (float)(val7)));
        }
        BarDataSet set1;
        set1 = new BarDataSet(yVals7, "Nguyễn Khánh Duy");
        ...
        dataSets.add(set1);
        databar7 = new BarData(dataSets);
        databar7.setValueTextSize(15f);
        databar7.setBarWidth(0.5f);
    }
}
