...
public class BarChart9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView10 = findViewById(R.id.textviewtenduong9);
        ...
        Des9 = intent.getStringExtra("tencot9"); // Lấy tên cột 8
        ...
        textView10.setText("9-" + Des9); // Hiển thị tên cộ 9
        ...
        l.setXEntrySpace(4f);
        setDataBar9(9, 100);
        mChart.setData(databar9); //Đã khai báo ở trên BarData databar3;
    ...
    private void setDataBar9(int count, float range) {
        ...
        BarDataSet set1;
        set1 = new BarDataSet(yVals9, "Nguyễn Khánh Duy");
        ...
        int startColor9 = ContextCompat.getColor(this, android.R.color.holo_green_dark);
