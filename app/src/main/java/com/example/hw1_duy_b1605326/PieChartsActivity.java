...
public class PieChartsActivity extends AppCompatActivity {
    ...
    PieData data2,data3,data4,data5,data6,data7,data8,data9;
    Button btnsave;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pie_charts);
        pieChartMp=findViewById(R.id.PieChartMp);
        ...
        btnVeMp=findViewById(R.id.btnVePieCharts);
        btnthoat=findViewById(R.id.btnthoatPieCharts);
            ...
            public void onClick(View v) {
                ...
                switch (vitri){
                    case 2:
                        ...
                        DecimalFormat df= new DecimalFormat("0.0");// làm tròn với 3 chữ số thập phân, muốn bao nhiêu chữ số sau dấu phẩy //thì thêm bấy nhiêu số 0.
...
//tổng số liệu nhập vào
    ...
    private void setData2(int count, float range) {
        ...
        for (int i = 0; i < count; i++) {
            yEntrys .add(new PieEntry((float) (yData2[i]/tong2)*100, mParties[i % mParties.length]));
        }
...
//
    ...
    private void setData6(int count, float range) {
        ...
        for (int i = 0; i < count; i++) {
            // yEntrys.add(new PieEntry((float)()
            yEntrys .add(new PieEntry((float) (yData6[i]/tong6)*100, mParties[i % mParties.length]));
        }
        PieDataSet dataSet = new PieDataSet(yEntrys,null);
        dataSet.setSliceSpace(3f);
        dataSet.setIconsOffset(new MPPointF(0, 40));
...
//
    ...
    private void setData8(int count, float range) {
        ...
        for (int i = 0; i < count; i++) {
            yEntrys .add(new PieEntry((float) (yData8[i]/tong8)*100, mParties[i % mParties.length]));
        }
        PieDataSet dataSet = new PieDataSet(yEntrys,null);
        //dataSet.setDrawIcons(false);
        dataSet.setSliceSpace(3f);
...
//
    ...
    private void setData9(int count, float range) {
        ...
        double[]
                yData9={amount1,amount2,amount3,amount4,amount5,amount6,amount7,amount8,amount9};
        for (int i = 0; i < count; i++) {
