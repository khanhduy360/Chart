...
import com.example.hw1_duy_b1605326.BarChart.BarChart2;
import com.example.hw1_duy_b1605326.BarChart.BarChart3;
import com.example.hw1_duy_b1605326.BarChart.BarChart4;
import com.example.hw1_duy_b1605326.BarChart.BarChart5;
import com.example.hw1_duy_b1605326.BarChart.BarChart6;
import com.example.hw1_duy_b1605326.BarChart.BarChart7;
import com.example.hw1_duy_b1605326.BarChart.BarChart8;
import com.example.hw1_duy_b1605326.BarChart.BarChart9;
...
public class BarChartsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTotal =  findViewById(R.id.tvTotal1);
        tvTotalPt =  findViewById(R.id.tvTotal2);
        edttitle =  findViewById(R.id.edtTitle);
        tvTotal =  findViewById(R.id.tvTotal1);
        tvTotalPt =  findViewById(R.id.tvTotal2);
        edtso1 =  findViewById(R.id.edtAmount1);
        edtso2 =  findViewById(R.id.edtAmount2);
        edtso3 =  findViewById(R.id.edtAmount3);
        edtso4 = findViewById(R.id.edtAmount4);
        edtso5 =  findViewById(R.id.edtAmount5);
        edtso6 = findViewById(R.id.edtAmount6);
        edtso7 =  findViewById(R.id.edtAmount7);
        edtso8 =  findViewById(R.id.edtAmount8);
        edtso9 =  findViewById(R.id.edtAmount9);
        edtDes1 =  findViewById(R.id.edtDescription1);
        edtDes2 = findViewById(R.id.edtDescription2);
        edtDes3 =  findViewById(R.id.edtDescription3);
        edtDes4 =  findViewById(R.id.edtDescription4);
        edtDes5 =  findViewById(R.id.edtDescription5);
        edtDes6 =  findViewById(R.id.edtDescription6);
        edtDes7 =  findViewById(R.id.edtDescription7);
        edtDes8 =  findViewById(R.id.edtDescription8);
        edtDes9 =  findViewById(R.id.edtDescription9);
        tv1 = findViewById(R.id.tvphantram1);
        tv2 =  findViewById(R.id.tvphantram2);
        tv3 =  findViewById(R.id.tvphantram3);
        tv4 =  findViewById(R.id.tvphantram4);
        tv5 =  findViewById(R.id.tvphantram5);
        tv6 =  findViewById(R.id.tvphantram6);
        tv7 =  findViewById(R.id.tvphantram7);
        tv8 =  findViewById(R.id.tvphantram8);
        tv9 =  findViewById(R.id.tvphantram9);
        tvtlaytitle =  findViewById(R.id.laytitle);
        ...
        tableLayout =  findViewById(R.id.tableLayout);
        btnVeBar =  findViewById(R.id.btnVeBarCharts);
        //tạo biểu đồ cột
        ...
        //tạo spinner
        spinner =  findViewById(R.id.spinnerMp);
...
// tvtlaytitle.setText("Đồ thị:"+lay5);
//lay du lieu
                        amountbar1 = Double.parseDouble(edtso1.getText().toString());
                        amountbar2 = Double.parseDouble(edtso2.getText().toString());
                        amountbar3 = Double.parseDouble(edtso3.getText().toString());
                        ...
                        //tính số phần trăm từng phần
                        DecimalFormat df345 = new DecimalFormat("0.0");// làm tròn với 3 chữ số thập phân, muốn bao nhiêu chữ số sau dấu phẩy //thì thêm bấy nhiêu số 0.
                        double tong3pt45 = amountbar1 + amountbar2 + amountbar3 +
                                amountbar4 + amountbar5;
                        ...
                        //tổng số liệu nhập vào
                        double tong345 = amountbar1 + amountbar2 + amountbar3 +
                                amountbar4 + amountbar5;
...
// tvtlaytitle.setText("Đồ thị:"+lay6);
                        amountbar1 = Double.parseDouble(edtso1.getText().toString());
                        amountbar2 = Double.parseDouble(edtso2.getText().toString());
                        amountbar3 = Double.parseDouble(edtso3.getText().toString());
                        amountbar4 = Double.parseDouble(edtso4.getText().toString());
                        ...
                        //tính số phần trăm từng phần
                        DecimalFormat df3456 = new DecimalFormat("0.0");// làm tròn với 3 chữ số thập phân, muốn bao nhiêu chữ số sau dấu phẩy //thì thêm bấy nhiêu số 0.
                        double tong3pt456 = amountbar1 + amountbar2 + amountbar3 +
                                amountbar4 + amountbar5 + amountbar6;
                        ...
                        //tổng số liệu nhập vào
                        double tong3456 = amountbar1 + amountbar2 + amountbar3 +
                                amountbar4 + amountbar5 + amountbar6;
                        String togAmount3456 = df3456.format(tong3456);
                        tvTotal.setText(togAmount3456);
                        //tổng số phần trăm
                        double tong23456 = in13456 + in23456 + in33456 + in44456 +
                                in55556 + in66666;
...
// tvtlaytitle.setText("Đồ thị:"+lay7);
                        amountbar1 = Double.parseDouble(edtso1.getText().toString());
                        amountbar2 = Double.parseDouble(edtso2.getText().toString());
                        amountbar3 = Double.parseDouble(edtso3.getText().toString());
                        amountbar4 = Double.parseDouble(edtso4.getText().toString());
                        ...
                        //tính số phần trăm từng phần
                        DecimalFormat df34567 = new DecimalFormat("0.0");// làm tròn với 3 chữ số thập phân, muốn bao nhiêu chữ số sau dấu phẩy //thì thêm bấy nhiêu số 0.
                        double tong3pt4567 = amountbar1 + amountbar2 + amountbar3 +
                                amountbar4 + amountbar5 + amountbar6 + amountbar7;
                        ...
                        //tổng số liệu nhập vào
                        double tong34567 = amountbar1 + amountbar2 + amountbar3 +
                                amountbar4 + amountbar5 + amountbar6 + amountbar7;
                        String togAmount34567 = df34567.format(tong34567);
                        tvTotal.setText(togAmount34567);
                        //tổng số phần trăm
                        double tong234567 = in134567 + in234567 + in334567 + in444567
                                + in555567 + in666667 + in777777;
...
// tvtlaytitle.setText("Đồ thị:"+lay8);
                        amountbar1 = Double.parseDouble(edtso1.getText().toString());
                        amountbar2 = Double.parseDouble(edtso2.getText().toString());
                        amountbar3 = Double.parseDouble(edtso3.getText().toString());
                        amountbar4 = Double.parseDouble(edtso4.getText().toString());
                        ...
                        //tính số phần trăm từng phần
                        DecimalFormat df345678 = new DecimalFormat("0.0");// làm tròn với 3 chữ số thập phân, muốn bao nhiêu chữ số sau dấu phẩy //thì thêm bấy nhiêu số 0.
                        double tong3pt45678 = amountbar1 + amountbar2 + amountbar3 +
                                amountbar4 + amountbar5 + amountbar6 + amountbar7 + amountbar8;
                        ...
                        //tổng số liệu nhập vào
                        double tong345678 = amountbar1 + amountbar2 + amountbar3 +
                                amountbar4 + amountbar5 + amountbar6 + amountbar7 + amountbar8;
                        String togAmount345678 = df345678.format(tong345678);
                        tvTotal.setText(togAmount345678);
                        //tổng số phần trăm
                        double tong2345678 = in1345678 + in2345678 + in3345678 +
                                in4445678 + in5555678 + in6666678 + in7777778 + in8888888;
...
//intent
                    ...
                    case 9:
                        ...
                        //tvtlaytitle.setText("Đồ thị:"+lay9);
                        amountbar1 = Double.parseDouble(edtso1.getText().toString());
                        amountbar2 = Double.parseDouble(edtso2.getText().toString());
                        amountbar3 = Double.parseDouble(edtso3.getText().toString());
                        amountbar4 = Double.parseDouble(edtso4.getText().toString());
                        ...
                        //tính số phần trăm từng phần
                        DecimalFormat df3456789 = new DecimalFormat("0.0");// làm tròn với 3 chữ số thập phân, muốn bao nhiêu chữ số sau dấu phẩy //thì thêm bấy nhiêu số 0.
                        double tong3pt456789 = amountbar1 + amountbar2 + amountbar3 +
                                amountbar4 + amountbar5 + amountbar6 + amountbar7 + amountbar8 + amountbar9;
                        ...
                        //tổng số liệu nhập vào
                        double tong3456789 = amountbar1 + amountbar2 + amountbar3 +
                                amountbar4 + amountbar5 + amountbar6 + amountbar7 + amountbar8 + amountbar9;
